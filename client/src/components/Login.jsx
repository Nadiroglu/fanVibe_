        ...
        <div class="md:max-w-md w-full sm:px-6 py-4">
          <form onSubmit={handleSubmit}>
            <div class="mb-12">
              ...
              <p class="text-sm mt-4 ">Don't have an account <NavLink to={'/signup'} className="text-blue-600 font-semibold hover:underline ml-1 whitespace-nowrap">Register here</NavLink></p>
            </div>
            <div>
              <label class="text-xs block mb-2">Username</label>
              <div class="relative flex items-center">
                <input onChange={(e) => setUsername(e.target.value)} name="username" type="text" required class="w-full text-sm border-b border-gray-300 focus:border-[#333] px-2 py-3 outline-none" placeholder="Enter username" />
              </div>
            </div>
            <div class="mt-8">
              <label class="text-xs block mb-2">Password</label>
              <div class="relative flex items-center">
                <input onChange={(e) => setPassword(e.target.value)} name="password" type="password" required class="w-full text-sm border-b border-gray-300 focus:border-[#333] px-2 py-3 outline-none" placeholder="Enter password" />
