  ...
  return (
    ...
    <div className="max-w-sm rounded-lg bg-blue-800 overflow-hidden shadow-lg m-4 mr-20">
        ...
        <div className="flex">
            <div className="flex-1">
                ...
                <p className="px-4 ml-2 mb-3 w-48 text-xs text-gray-400">5,466 Popularity</p>
    ...
    <div className="flex">
        <div className="flex-1">
            ...
            <p className="px-4 ml-2 mb-3 w-48 text-xs text-gray-400">8,464 Popularity</p>
    ...
    <div className="flex">
        <div className="flex-1">
            ...
            <p className="px-4 ml-2 mb-3 w-48 text-xs text-gray-400">5,586 Popularity</p>
    ...
    <div className="flex">
        <div className="flex-1">
            ...
            <p className="px-4 ml-2 mb-3 w-48 text-xs text-gray-400">9,416 Popularity</p>
