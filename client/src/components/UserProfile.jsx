  ...
  return (
    ...
    <aside class="hidden py-4 md:w-1/3 lg:w-1/4 md:block">
        <div class="sticky flex flex-col gap-2 p-4 text-sm border-r border-indigo-100 top-12">
            ...
            <NavLink to={`/user/${id}/changepassword`} className="flex items-center px-3 py-2.5 font-semibold  hover:text-indigo-900 hover:border hover:rounded-full">
                Change Password
            </NavLink>
            <a href="#"
                class="flex items-center px-3 py-2.5 font-semibold hover:text-indigo-900 hover:border hover:rounded-full  ">
        ...
        <div class="p-2 md:p-4">
            <div class="w-full px-6 pb-8 mt-8 sm:max-w-xl sm:rounded-lg">
                ...
                <div class="grid max-w-2xl mx-auto mt-8">
                    ...
                    <form class="items-center mt-8 sm:mt-14 text-[#202142]">
                        ...
                        {user && (
                            ...
                            <div class="w-full">
                                <label for="first_name"
                                    class="block mb-2 text-sm font-medium text-indigo-900 dark:text-indigo-900">Your first name</label>
                            ...
                            <div class="w-full">
                                <label for="last_name"
                                    class="block mb-2 text-sm font-medium text-indigo-900 dark:text-indigo-900">Your last name</label>
                        ...
                        <div class="mb-2 sm:mb-6">
                            <label for="email"
                                class="block mb-2 text-sm font-medium text-indigo-900 dark:text-indigo-900">Your
                                email</label>
                        ...
                        <div class="mb-2 sm:mb-6">
                            <label for="profession"
                                class="block mb-2 text-sm font-medium text-indigo-900 dark:text-indigo-900">Profession</label>
                        ...
                        <div class="mb-6">
                            <label for="message"
                                class="block mb-2 text-sm font-medium text-indigo-900 dark:text-indigo-900">Bio</label>
